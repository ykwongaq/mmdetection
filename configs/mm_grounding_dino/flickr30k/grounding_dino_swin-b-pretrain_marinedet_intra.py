...
dataset_class_seen = dict(
    type=dataset_type,
    data_root=data_root,
    ann_file='annotations/intra_class_val_seen_grounding_filtered.json',
...
dataset_class_unseen = dict(
    type=dataset_type,
    data_root=data_root,
    ann_file='annotations/intra_class_val_unseen_grounding_filtered.json',
    data_prefix=dict(img='.'),
    pipeline=test_pipeline,
)
...
# ----------Config---------- #
dataset_prefixes = ['MarineDet_Intra_Class_Seen', 'MarineDet_Intra_Class_Unseen']
