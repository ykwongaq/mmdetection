...
marindet_dataset = dict(
    ...
    ann_file="annotations/inter_class_train_grounding_filtered_processed.json",
    label_map_file=None,
...
dataset_class_seen = dict(
    type=dataset_type,
    data_root=data_root,
    ann_file="annotations/inter_class_val_seen_grounding.json",
    data_prefix=dict(img="."),
...
dataset_class_unseen = dict(
    type=dataset_type,
    data_root=data_root,
    ann_file="annotations/inter_class_val_unseen_grounding.json",
    data_prefix=dict(img="."),
    pipeline=test_pipeline,
)
...
# ----------Config---------- #
dataset_prefixes = ["MarineDet_Inter_Seen", "MarineDet_Inter_Unseen"]
