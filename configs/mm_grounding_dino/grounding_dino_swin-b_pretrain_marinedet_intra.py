...
marindet_dataset = dict(
    ...
    ann_file="annotations/intra_class_train_grounding_filtered_processed.json",
    label_map_file=None,
...
dataset_class_seen = dict(
    type=dataset_type,
    data_root=data_root,
    ann_file="annotations/intra_class_val_seen_grounding.json",
    data_prefix=dict(img="."),
...
dataset_class_unseen = dict(
    type=dataset_type,
    data_root=data_root,
    ann_file="annotations/intra_class_val_unseen_grounding.json",
    data_prefix=dict(img="."),
    pipeline=test_pipeline,
)
...
# ----------Config---------- #
dataset_prefixes = ["MarineDet_Intra_Seen", "MarineDet_Intra_Unseen"]
