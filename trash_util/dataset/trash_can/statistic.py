...
def main(args):
    ...
    train_json_file = os.path.join(data_dir, "instances_train_trashcan.json")
    ...
    val_json_file = os.path.join(data_dir, "instances_val_trashcan.json")
...
if __name__ == "__main__":
    DEFAULT_DATASET_DIR = "/mnt/hdd/davidwong/data/trash/TrashCan"
