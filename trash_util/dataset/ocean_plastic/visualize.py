...
def main(args):
    ...
    train_json_path = os.path.join(data_dir, "train_annotations.json")
...
if __name__ == "__main__":
    DEFAULT_DATA_DIR = "/mnt/hdd/davidwong/data/trash/Ocean_Plastic"
    DEFAULT_OUTPUT_DIR = "/mnt/hdd/davidwong/vis/ocean_plastic"
